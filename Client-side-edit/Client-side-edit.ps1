...
#
#   irm https://raw.githubusercontent.com/Ongidev/Vencord-extras/refs/heads/main/Client-cide-edit/Client-side-edit.ps1 | iex
#
# ──────────────────────────────────────────────────────────────────────────────
...
# ── Download clientSideEdit.tsx from GitHub ───────────────────────────────────
$pluginUrl  = "https://raw.githubusercontent.com/On+gidev/Vencord-extras/refs/heads/main/clientSideEdit.tsx"
...
try {
    Invoke-WebRequest -Uri $pluginUrl -OutFile $pluginDest -UseBasicParsing
